...
const server_url = process.env.NODE_ENV === 'production' ? 'https://socket-meet-clone.herokuapp.com' : "http://localhost:4001"
...
class Video extends Component {
	...
	connectToSocketServer = () => {
		socket = io.connect(server_url, { withCredentials: true })
